...
class ValidationUtils:
    ...
    def validate_configuration(self, config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            required_params = ['two_system_decision_making', 'awareness_level']
            ...
            if 'two_system_decision_making' in move_rules:
                decision_making = move_rules['two_system_decision_making']
                if not isinstance(decision_making, bool):
                    self.logger.error(f"Invalid move_rules.two_system_decision_making: {decision_making}")
                    return False
