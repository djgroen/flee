...
class SimulationSettings:
    ...
    def ReadFromYML(ymlfile: str):
        ...
        for a in ["WomenAvoidHazards", "ChildrenAvoidHazards", "ElderlyAvoidHazards", "BoysTakeRisk", "MatchCampReligion", "MatchCampEthnicity", "MatchTownEthnicity", "MatchConflictEthnicity"]:
