...
if __name__ == "__main__":
  ...
  flee.SimulationSettings.FloodInputFile = "%s/floods.csv" % input_csv_directory

  e = flee.Ecosystem()

  ig = InputGeography.InputGeography()

  ig.ReadFloodInputCSV(flee.SimulationSettings.FloodInputFile)
  ...
  for t in range(0,end_time):
    ...
    spawning.refresh_conflict_spawn_weights(e)
    t_data = t
