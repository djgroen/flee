...
if __name__ == "__main__":
    ...
    ig.ReadLocationsFromCSV(
        "conflict_input/testmscale/locations-%s.csv" % submodel_id)

    ig.ReadLinksFromCSV(
        "conflict_input/testmscale/routes-%s.csv" % submodel_id)

    ig.ReadClosuresFromCSV(
        "conflict_input/testmscale/closures-%s.csv" % submodel_id)
