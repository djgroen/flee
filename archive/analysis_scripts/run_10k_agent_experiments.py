#!/usr/bin/env python3
"""
Run 10k Agent Experiments
- Execute actual Flee simulations with 10k agents
- Generate output files and results
- Compare with smaller population experiments
"""
...
def run_10k_agent_experiment(exp_dir):
...
def main():
    ...
    print("🚀 Running 10k Agent Experiments")
    print("=" * 60)
    ...
    for exp_dir in experiment_dirs:
        print(f"\n{'='*60}")
        result = run_10k_agent_experiment(exp_dir)
