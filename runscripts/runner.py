...
class Simulation:
    ...
    def setup(self):
        ...
        try:
            ...
            print("ValueError in simulation setup: {}".format(e))
            raise
        except TypeError as e:
            print("TypeError in simulation setup: {}".format(e))
            raise
    ...
    def run(self):
        try:
            ...
            print("ValueError in setup: {}".format(e))
            raise
        except TypeError as e:
            print("TypeError in setup: {}".format(e))
            raise
        ...
        try:
            ...
            print("ValueError in simulation run: {}".format(e))
            raise
        except TypeError as e:
            print("TypeError in simulation run: {}".format(e))
            raise
