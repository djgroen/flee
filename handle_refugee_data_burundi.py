...
def ConvertCsvFileToNumPyTable(csv_name, start_date="2015-05-01"):
  """
  Converts a CSV file to a table with date offsets from 01 may 2015.
...
class DataTable:
  def __init__(self, name="", csvformat="burundi-pdf", data_directory="burundi2015", data_layout="data_layout_refugee.csv"):
    """
    ...
    if self.csvformat=="burundi-pdf":
      ...
      self.header = ["days","Rwanda","Tanzania","Uganda","Congo"]


    # Example of loading in data from the mali2012 directory.
    if self.csvformat=="burundi-portal":
      self.header = ["total","Mahama","Nduta","Nyarugusu","Nakivale","Lusenda"]

      self.data_table = [ConvertCsvFileToNumPyTable('burundi2015/refugees.csv'),
      ConvertCsvFileToNumPyTable('burundi2015/rwa-mahama.csv'),
      ConvertCsvFileToNumPyTable('burundi2015/tan-nduta.csv'),
      ConvertCsvFileToNumPyTable('burundi2015/tan-nyarugusu.csv'),
      ConvertCsvFileToNumPyTable('burundi2015/uga-nakivale.csv'),
      ConvertCsvFileToNumPyTable('burundi2015/con-lusenda.csv')]
  ...
  def get_new_refugees(self, day, format="burundi-portal", Debug=False, FullInterpolation=False):
    """
